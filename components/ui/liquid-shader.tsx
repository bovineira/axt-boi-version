...
/**
 * Full-screen nebula shader background com cores escuras e pouca luminosidade azul
 */
export function InteractiveNebulaShader({
  ...
  useEffect(() => {
    ...
    // Ray-marched nebula fragment shader - cores escuras com pouca luminosidade azul

...
import { Search, Facebook, Music2, Instagram } from 'lucide-react'
    ...
    <section className="relative min-h-screen flex items-center justify-center pt-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto w-full relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Coluna Direita - Escolha de Plataforma */}
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            <div className="space-y-8">
              ...
              >
                <h2 className="text-3xl sm:text-4xl font-bold mb-4 text-glow">
                  ...
                  {[
                    {
                      ...
                      onClick: () => console.log('Google Ads selecionado')
                    },
                    {
                      title: 'Meta Ads',
                      ...
                      onClick: () => console.log('Meta Ads selecionado')
                    },
                    {
                      title: 'TikTok Ads',
                      ...
                      onClick: () => console.log('TikTok Ads selecionado')
                    },
                    {
                      title: 'Instagram',
                      ...
                      onClick: () => console.log('Instagram selecionado')
                    }
                  ].map((item, idx) => (
                    <DockItem
                      key={idx}
                      onClick={item.onClick}
                      className={`aspect-square rounded-2xl bg-gradient-to-br ${item.gradient} backdrop-blur-xl border ${item.borderColor} glass relative overflow-hidden`}
                    >
                      <GlowingEffect
                        spread={30}
                        glow={true}
